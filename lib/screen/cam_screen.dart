...
import 'package:video_call_v6/const/agora.dart';
    ...
    if (engine == null) {
      ...
      engine!.registerEventHandler(
        RtcEngineEventHandler(
          ...
          debugPrint('채널에 입장했습니다. uid: ${connection.localUid}');
          setState(() {
          ...
          debugPrint('상대가 채널에 입장했습니다. otherUid: $remoteUid');
          setState(() {
            otherUid = remoteUid;
          });
        },
          ...
          debugPrint('상대가 채널에서 나갔습니다. otherUid: $remoteUid');
          setState(() {
            otherUid = null;
          });
        }),
